...
<template>
  <section class="hero" id="hero">
    <Wave class="hero__wave" />
    <div class="hero__content hero__content--left">
      <div class="hero__details">
        <p class="hero__greetings">Hi there!, I am</p>
        <h1 class="hero__name">
          <span>Julius </span>
          <span>Ian</span>
        </h1>
        <div class="hero__lines lines-wave">
          <div class="line"></div>
          <div class="line"></div>
        </div>
    ...
    <div class="hero__content hero__content--right">
      <div class="hero__frame">
        <div class="hero__photo">
          <img src="@/assets/images/ian/ian-hero.png" class="photo" alt="Julius Ian Valdez Photo" />
        </div>
      </div>

      <RippleBackground class="hero__ripple" />
    </div>
  </section>
</template>
